...
//    option.tenantId = lgM.tenantId;
    option.appkey = [GlobalSetting shareSetting].currentAppkey;
    //Appkey; // @"1418190306068494#kefuchannelapp67176";//@"1452190305061842#kefuchannelapp67039";
    option.tenantId = [GlobalSetting shareSetting].currentTenantId;//TenantId; //@"67176";//@"67039";
